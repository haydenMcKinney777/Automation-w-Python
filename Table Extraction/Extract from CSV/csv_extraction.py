"""
Simple program that extracts a csv file found from a URL using only pandas. csv files are found at the website https://www.football-data.co.uk/data.php and within this website
...
#if you were to print df_japan, you would see the dataframe table output in the terminal window. You might see some terms in the columns
